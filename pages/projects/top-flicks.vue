  ...
  >
    ...
    <section class="mb-8">
      ...
      <p class="text-lg leading-relaxed mb-4">
        Top Flicks is a school project web application built with HTML, CSS, and
        JavaScript for browsing and managing your favorite movies.
      </p>
      <p class="text-lg leading-relaxed">
        Users can register, log in, search for movies, and add them to their
        favorites.
      </p>
    </section>
